# Elasto Mania for Miyoo Mini

A port of [Elasto Mania](https://elastomania.com/) (the classic motorbike physics game) to the **Miyoo Mini Plus** handheld running **OnionOS**.
...
# Strip and copy binary to deploy directory
make TARGET=miyoo package
```
...
- **Elasto Mania** by Balázs Rózsa — the original game
